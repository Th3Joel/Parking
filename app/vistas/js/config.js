function empresa() {
	$("#btnEmpresaDisplay").html(
		"<button id='btnEmpresaConfig' class='btn btn-primary animate__animated animate__rubberBand' disabled><div class='spinner-grow spinner-grow-sm' role='status'></div></button>"
	);
...
function cambiar(img, inp, imgSrc) {
	...
	if (archivo && archivo.type.startsWith("image/")) {
		...
		input.style =
			"border:1px solid red;transition:1s;width: 300px;margin-top: 13px;padding:4px;";
		setTimeout(function () {
